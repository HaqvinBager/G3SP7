...
PixelOutPut main(VertexToPixel input)
{
    ...
    float3 radiance = ambience + directionallight /** (1.0f - ShadowFactor(worldPosition, directionalLightPosition.xyz, toDirectionalLightView, toDirectionalLightProjection))*/ + pointLights + emissive;
