...
void CSceneManager::AddPlayer(CScene& aScene, RapidObject someData)
{
	...
	player->AddComponent<CPlayerControllerComponent>(*player, 0.09f, 0.05f, CEngine::GetInstance()->GetPhysx().GetPlayerReportBack());// CPlayerControllerComponent constructor sets position of camera child object.
