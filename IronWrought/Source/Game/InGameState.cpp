...
void CInGameState::Start()
{
	...
	std::vector<std::string> scenePaths = CFolderUtility::GetFileNamesInFolder(ASSETPATH("Assets\\Generated\\"), ".json", "SampleScene");
	CScene* scene = CSceneManager::CreateScene(scenePaths);
